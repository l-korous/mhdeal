...
class FE_DG_Taylor : public FiniteElement<dim,spacedim>, public FiniteElementIsConstantInterface<dim>
{
public:
  /**
   ...
   */
  FE_DG_Taylor (const unsigned int k);

  /**
   * Return a string that uniquely
   * identifies a finite
   * element. This class returns
   * <tt>FE_DG_Taylor<dim>(degree)</tt>,
   ...
   *
   * For the FE_DG_Taylor class the
...
private:
   ...
   */
  template <int, int> friend class FE_DG_Taylor;
