...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    if (std::abs(problem.res_norm - 1.77977597104473e-09) > 1e-14)
      throw std::runtime_error(std::string("Test FAILED, the problem.res_norm should have been 1.77977597104473e-09 and was ") + to_string_with_precision(problem.res_norm, 15));
    else
